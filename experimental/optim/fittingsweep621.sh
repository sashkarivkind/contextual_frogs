#!/usr/bin/env bash
#62x versions are the ones that are tried out sttarting mid January26 with
#direct injection and other tweaks added or at the very least considered 
set -euo pipefail
...
# bookkeeping
id=1
outdirroot="results/mem_upd_try6x1/"
mkdir -p "$outdirroot"
